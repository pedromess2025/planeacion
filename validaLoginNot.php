...
$noEmpleado = $_POST['noEmpleado']    ?? $_POST['noEmpleado']    ?? '';

    $Qempresas  =  "SELECT  *, TIMESTAMPDIFF(YEAR,fechaIngreso,CURDATE()) AS antiguedad, rol FROM usuarios WHERE noEmpleado  = '".$noEmpleado."' AND estatus = 1";
