...
header('Content-Type: application/json');
    ...
    if ($accion == 'obtenerEquipos') {
        ...
        $accesoInfoEqReparacion = isset($_POST['accesoInfoEqReparacion']) ? intval($_POST['accesoInfoEqReparacion']) : 0;
        $areaPermitidaInfoEqReparacion = isset($_POST['areaPermitidaInfoEqReparacion']) ? trim($_POST['areaPermitidaInfoEqReparacion']) : '';
        $stmt = null;
