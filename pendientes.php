                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <div class="row"> 
                                        ...
                                        <div class="col-sm-8">                                            
                                                <p class="fs-4"><b>SEGUIMIENTO DE ACTIVIDADES PENDIENTES</b></p>                                            
                                        </div>
                                    </div>
                                    <hr>
                                    <!--<div class="row mb-3">
        ...
        <div class="modal-dialog">            
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="ActualizarActividad('pendientes')">Actualizar</button>
